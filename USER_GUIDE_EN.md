...
- **Data Statistics** - Today's workout data and lifetime cumulative records
...
2. Wait for GPS positioning to succeed (ensure good signal)
3. Tap "Start" to enter the running interface
4. View real-time data including distance, time, and pace
...
2. Browse the list of all running records
3. Tap any record to view details
4. On the detail page, view:
...
- **Manual Switch** - Change appearance in system settings
...
- Supports iCloud backup (if enabled)
- Ensure data is backed up before uninstalling the app
...
> A: Please ensure you're using it in an open area, avoiding building obstructions. First-time use may require waiting about 30 seconds for positioning to complete.
...
> A: Currently supports Simplified Chinese and English, more languages will be added in future versions.
